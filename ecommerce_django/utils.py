...
class EcommerceManager:
        ...
        try:
            ...
            for source in sources["data"]:
                ...
                date = datetime.strptime(
                    f'{source["exp_month"]}/{source["exp_year"]}', "%m/%Y"
                )
    ...
    def list_sources(self):
        ...
        try:
            sources = stripe.Customer.list_sources(
                self.stripe_id(), limit=3, object="card"
            )
        except TypeError:
            sources = []
        return sources
    ...
    def post_source(self):
        ...
        source = stripe.Customer.create_source(stripe_id, source=self.token)
    ...
    def get_invoice(self):
        ...
        invoice_info = {
            ...
            "invoice_total": invoice["amount_paid"] / 100,
            "invoice_paid": invoice["paid"],
            "invoice_date": datetime.fromtimestamp(int(invoice["created"])).strftime(
                "%d-%m-%Y"
            ),
        }
        return invoice_info
